---
name: ABT-ticket-en
description: 'Sync external tickets into ABT, attach tickets to cases, list synced tickets, or update existing ticket records.'
...
Use this skill when the user needs to sync external tickets on ABT.
