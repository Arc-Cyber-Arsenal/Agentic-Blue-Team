---
name: ABT-alert-en
description: 'Review ABT alerts, update AI analysis fields, inspect alert discussions, or attach enrichment after analysis.'
...
Use this skill when the user needs to work on ABT alerts for SOC analysis.
An alert is secondary data in ABT. Each alert belongs to a case, and each alert can have one or more artifacts attached.
...
- If the user wants to save structured analysis back onto the alert, use the `ABT-enrichment-en` skill.
...
5. If the user wants to attach analysis results, intelligence, or structured context to the alert, use the `ABT-enrichment-en` skill.
