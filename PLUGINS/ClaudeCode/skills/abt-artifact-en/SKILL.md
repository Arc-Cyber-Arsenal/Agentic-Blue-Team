...
Use this skill when the user needs to investigate artifacts on ABT.
...
- For the full enrichment persistence workflow, use the `ABT-enrichment-en` skill.
...
2. If the user wants to attach intelligence, analysis notes, or structured analysis to an artifact, use the `ABT-enrichment-en` skill.
